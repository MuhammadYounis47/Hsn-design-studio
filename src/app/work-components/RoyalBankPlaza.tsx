...
import RoyalHero from '../components/royal-bank/RoyalHero'
import RoyalImageLayouts from '../components/royal-bank/RoyalImageLayouts'
import RelatedProjects from '../components/riocan/ReletedProject'
import Content from '../components/Content'
import Form from '../components/Form'
import ContactStrip from '../components/ContactStrip'
const RoyalBankPlaza = () => {
  return (
    <>
  ...
  projects={[
    {
      ...
      slug: '/project/carvalo-on-collage',
      image: '/work-4.jpg',
    },
    {
      id: 2,
